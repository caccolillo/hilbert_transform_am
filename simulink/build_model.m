...
lpf_order = 50;
cutoff_freq = 5000;     % Hz - adjusted for higher sampling rate
downsample_factor = 20; % Increased for higher sampling rate
...
% 5. Hilbert Transform (Discrete FIR Filter)
add_block('simulink/Discrete/Discrete FIR Filter', [model_name '/Hilbert_FIR']);
set_param([model_name '/Hilbert_FIR'], ...
    'Coefficients', mat2str(hilbert_coeffs), ...
...
% 10. Lowpass Filter for smoothing
add_block('simulink/Discrete/Discrete FIR Filter', [model_name '/Smoothing_LPF']);
set_param([model_name '/Smoothing_LPF'], ...
    'Coefficients', mat2str(lpf_coeffs), ...
