...
typedef ap_fixed<DataWordSize+CoeffWordSize+6, DataIntSize+CoeffIntSize, AP_TRN, AP_WRAP, 0> accum_type;

// Processes one sample through the fixed-point filter
